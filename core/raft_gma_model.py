...
# from swin_basic import BasicSwinUpdate
...
class RAFTGMAModel(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args
        
        self.args.num_heads = 1
        self.args.position_only = False
        self.args.position_and_content = False
