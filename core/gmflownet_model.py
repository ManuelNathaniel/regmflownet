...
class GMFlowNetModel(nn.Module):
    def __init__(self, args):
        ...
        # 【DROFlow】 fnet=BasicEncoder, cnet=BasicEncoder, update_block=BasicUpdateBlock
        # DROFlowNet中feature layer和context layer的BasicEncoder采用ResidualBlock块
        if self.args.use_mix_attn:
            self.fnet = nn.Sequential(
                            # BasicEncoder(output_dim=256, norm_fn='instance', dropout=args.dropout),
