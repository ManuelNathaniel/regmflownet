        ...
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                ...
                for val_dataset in args.validation:
                        results.update(evaluate.validate_baseflow(model.module, paras=args, split='validate',
                                                                  flowtype=val_dataset))
                        results.update(evaluate.test_baseflow(model.module, paras=args, split='test',
                                                              flowtype=val_dataset))
